...
class InventoryPackController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // The Transform Stock page only needs the selected source products and
        // their explicitly mapped transformation targets. Do not load the full
        // product catalogue into this operational screen.

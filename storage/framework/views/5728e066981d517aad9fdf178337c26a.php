...
<?php
    ...
    $isChefPicksCollection = Str::lower(trim((string) ($collection->slug ?? ''))) === 'chef-picks';
?>


<?php if (! $__env->hasRenderedOnce('c65ccef0-77e7-410f-b12c-8f6ed39ef72b')): $__env->markAsRenderedOnce('c65ccef0-77e7-410f-b12c-8f6ed39ef72b'); ?>
<style>
    .bcd-page {
        --bcd-bg: #f8fafc;
        --bcd-card: #fff;

<?php $__env->startSection('title', ($collection->name ?? config('app.name'))); ?>
...
<?php if($isOccasionCollection): ?>
<div class="boc-page">
    <main class="boc-shell">
        <nav class="boc-breadcrumb" aria-label="Breadcrumb">
            <a href="<?php echo e($homeUrl); ?>">Home</a>
            <span aria-hidden="true">/</span>
            <a href="<?php echo e($homeUrl); ?>#occasions">Collections</a>
            <span aria-hidden="true">/</span>
            <span aria-current="page"><?php echo e($occasion['title']); ?></span>
        </nav>
        ...
        <section class="boc-hero" aria-labelledby="occasion-collection-title">
            <div class="boc-hero-media">
                <?php if($collectionImage): ?>
                    <img
                        src="<?php echo e($collectionImage); ?>"
                        alt="<?php echo e($occasion['title']); ?>"
                ...
                <div class="boc-hero-count">
                    <?php echo e($productCount); ?> <?php echo e(Str::plural('product', $productCount)); ?>
            ...
            <div class="boc-hero-copy">
                <div>
                    <p class="boc-eyebrow"><?php echo e($occasion['eyebrow']); ?></p>
                    <h1 id="occasion-collection-title" class="boc-title"><?php echo e($occasion['title']); ?></h1>
                    <p class="boc-headline"><?php echo e($occasion['headline']); ?></p>
                    <p class="boc-intro"><?php echo e($occasion['intro']); ?></p>
                </div>
                ...
                <div class="boc-actions">
                    ...
                    <a href="<?php echo e($shopUrl); ?>" class="boc-secondary">
                        Browse all products
                        <svg class="boc-icon" viewBox="0 0 20 20" fill="none" aria-hidden="true">
        ...
        <section class="boc-benefits" aria-label="Why this collection is useful">
            <?php $__currentLoopData = $occasion['benefits']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="boc-benefit">
                    <span class="boc-benefit-number" aria-hidden="true"><?php echo e(str_pad((string) $loop->iteration, 2, '0', STR_PAD_LEFT)); ?></span>
                    <div>
                        <h2><?php echo e($benefit['title']); ?></h2>
                        <p><?php echo e($benefit['copy']); ?></p>
                    </div>
                </article>
        ...
        <section class="boc-guidance" aria-labelledby="occasion-guidance-title">
            <div class="boc-guidance-top">
                <div>
                    ...
                    <h2 id="occasion-guidance-title"><?php echo e($occasion['guidance_title']); ?></h2>
                </div>

                <p class="boc-guidance-copy"><?php echo e($occasion['guidance']); ?></p>
            </div>

            <div class="boc-guidance-steps" aria-label="Three ways to use this collection">
                <?php $__currentLoopData = $occasion['guidance_steps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="boc-guidance-step">
                        <span class="boc-guidance-step-number" aria-hidden="true"><?php echo e(str_pad((string) $loop->iteration, 2, '0', STR_PAD_LEFT)); ?></span>
                        <div>
        ...
        <section id="collection-products" class="boc-products" aria-labelledby="occasion-products-title">
            <header class="boc-products-header">
                <div>
                    ...
                    <h2 id="occasion-products-title" class="boc-products-title"><?php echo e($occasion['products_title']); ?></h2>
                    <p class="boc-products-copy"><?php echo e($occasion['products_copy']); ?></p>
                </div>

                <div class="boc-products-count" aria-label="<?php echo e($productCount); ?> products in this collection">
                    <strong><?php echo e($productCount); ?></strong>
                    <span><?php echo e(Str::plural('product', $productCount)); ?></span>
                </div>
            </header>
            ...
            <?php if($products->count() === 0): ?>
                <div class="boc-empty">
                    ...
                    <a href="<?php echo e($shopUrl); ?>" class="boc-primary">
                        Visit the shop
                        <svg class="boc-icon" viewBox="0 0 20 20" fill="none" aria-hidden="true">
                            <path d="M4 10h12M11.5 5.5 16 10l-4.5 4.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
            ...
            <?php else: ?>
                <div class="boc-product-grid">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e($productUrl($product)); ?>" class="boc-product-card" aria-label="View <?php echo e($productName); ?>">
                            ...
                            <div class="boc-product-body">
                                <div>
                                    <h3 class="boc-product-title"><?php echo e($productName); ?></h3>

                                    <?php if($productDescription !== ''): ?>
                                        <p class="boc-product-description"><?php echo e($productDescription); ?></p>
                                    <?php endif; ?>
                                </div>

                                <div class="boc-product-footer">
                                    <span class="boc-origin">
                                        <?php if($productOrigin): ?>
                                            <span class="boc-origin-label">Country of origin</span>
                                            <span class="boc-origin-value"><?php echo e($productOrigin); ?></span>
                                        <?php else: ?>
                ...
                <?php if(method_exists($products, 'links')): ?>
                    <div class="boc-pagination"><?php echo e($products->links()); ?></div>
                <?php endif; ?>
            <?php endif; ?>
        </section>
        ...
        <section class="boc-related" aria-labelledby="other-collections-title">
            ...
            <div class="boc-related-grid">
                <?php $__currentLoopData = $otherOccasions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($related['url']); ?>" class="boc-related-card" aria-label="Explore <?php echo e($related['title']); ?>">
                        <div class="boc-related-media">
                            <?php if($related['image']): ?>
                                <img src="<?php echo e($related['image']); ?>" alt="<?php echo e($related['title']); ?>" class="boc-related-image" loading="lazy">
                            <?php else: ?>
                        ...
                        <div class="boc-related-copy">
                            <p class="boc-related-eyebrow"><?php echo e($related['eyebrow']); ?></p>
                            <h3><?php echo e($related['title']); ?></h3>
                            <p><?php echo e($related['copy']); ?></p>
...
<?php else: ?>
<div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['bcd-page', 'bcd-page--chef-picks' => $isChefPicksCollection]); ?>">
    <main class="bcd-shell">
        <nav class="bcd-breadcrumb" aria-label="Breadcrumb">
            <a href="<?php echo e($homeUrl); ?>">Home</a>
            <span aria-hidden="true">/</span>
            <a href="<?php echo e($shopUrl); ?>">Shop</a>
            <span aria-hidden="true">/</span>
            <span aria-current="page"><?php echo e($collection->name ?? 'Collection'); ?></span>
        </nav>
        ...
        <section class="bcd-hero" aria-labelledby="collection-title">
            <div class="bcd-hero-media">
                <?php if($collectionImage): ?>
                    <img
                        src="<?php echo e($collectionImage); ?>"
                        alt="<?php echo e($collection->name ?? 'Bandara collection'); ?>"
                ...
                <div class="bcd-image-caption" aria-hidden="true">
                    ...
                    <span><?php echo e($productCount); ?> <?php echo e(Str::plural('product', $productCount)); ?></span>
                </div>
            </div>
            ...
            <div class="bcd-hero-copy">
                <div>
                    ...
                    <p class="bcd-eyebrow"><?php echo e($collectionLabel); ?></p>
                    <h1 id="collection-title" class="bcd-title"><?php echo e($collection->name ?? 'Collection'); ?></h1>
                    <p class="bcd-description"><?php echo e($collectionDescription); ?></p>
                </div>
                ...
                <div class="bcd-actions">
                    ...
                    <a href="<?php echo e($shopUrl); ?>" class="bcd-secondary">
        ...
        <aside class="bcd-meta" aria-label="Collection summary">
            ...
            <div class="bcd-meta-item">
                ...
                <span class="bcd-meta-value"><?php echo e($collectionLabel); ?></span>
            </div>
            <div class="bcd-meta-item">
                <span class="bcd-meta-label">Collection size</span>
                <span class="bcd-meta-value"><?php echo e($productCount); ?> <?php echo e(Str::plural('product', $productCount)); ?></span>
            </div>
        </aside>
        ...
        <section id="collection-products" class="bcd-products" aria-labelledby="collection-products-title">
            <header class="bcd-products-header">
                <div>
                    ...
                    <h2 id="collection-products-title" class="bcd-section-title">
                        Everything in <?php echo e($collection->name ?? 'this collection'); ?>
                ...
                <div class="bcd-count" aria-label="<?php echo e($productCount); ?> products in this collection">
                    <strong><?php echo e($productCount); ?></strong>
                    <span><?php echo e(Str::plural('product', $productCount)); ?></span>
                </div>
            </header>
            ...
            <?php if($products->count() === 0): ?>
                <div class="bcd-empty">
                    ...
                    <a href="<?php echo e($shopUrl); ?>" class="bcd-primary">
                        Visit the shop
                        <svg class="bcd-icon" viewBox="0 0 20 20" fill="none" aria-hidden="true">
                            <path d="M4 10h12M11.5 5.5 16 10l-4.5 4.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
            ...
            <?php else: ?>
                <div class="bcd-grid">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e($productUrl($product)); ?>" class="bcd-card" aria-label="View <?php echo e($productName); ?>">
                            ...
                            <div class="bcd-card-body">
                                <div class="bcd-card-copy">
                                    ...
                                    <h3 class="bcd-card-title"><?php echo e($productName); ?></h3>

                                    <?php if($productDescription !== ''): ?>
                                        <p class="bcd-card-description"><?php echo e($productDescription); ?></p>
                                    <?php endif; ?>
                                </div>
                ...
                <?php if(method_exists($products, 'links')): ?>
                    <div class="bcd-pagination"><?php echo e($products->links()); ?></div>
                <?php endif; ?>
            <?php endif; ?>
        </section>
    </main>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/collections/show.blade.php ENDPATH**/ ?>
...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <form method="POST" action="<?php echo e(route('admin.product-collections.update', $productCollection)); ?>" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/product_collections/edit.blade.php ENDPATH**/ ?>
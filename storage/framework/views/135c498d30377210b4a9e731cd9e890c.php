<?php $__env->startSection('title', 'Terms & Policies'); ?>
    ...
    <div class="min-h-screen bg-stone-50 text-slate-800 dark:bg-slate-950 dark:text-slate-200">
        <header class="border-b border-stone-200 bg-white dark:border-slate-800 dark:bg-slate-950">
            <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
                ...
                <p class="mt-5 max-w-3xl text-sm font-light leading-7 text-slate-600 dark:text-slate-300 sm:text-base">These terms govern use of the Bandara website and purchases from <?php echo e($company['legal_name']); ?>. Consumer and business-specific provisions are identified where they differ.</p>
        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.28fr_0.72fr] lg:px-8 lg:py-16">
            ...
            <article class="space-y-12 text-sm font-light leading-7 text-slate-600 dark:text-slate-300 [&_h2]:text-2xl [&_h2]:font-light [&_h2]:tracking-tight [&_h2]:text-slate-950 dark:[&_h2]:text-white [&_h3]:mt-6 [&_h3]:font-normal [&_h3]:text-slate-900 dark:[&_h3]:text-slate-100 [&_li]:ml-5 [&_li]:list-disc [&_p+p]:mt-4 [&_ul]:mt-4 [&_ul]:space-y-2">
                <section id="scope" class="scroll-mt-28">
                    ...
                    <p>These Terms & Policies apply to the shopping website at <?php echo e($company['shopping_domain']); ?>, related Bandara account features, and orders accepted by <?php echo e($company['legal_name']); ?>. References to “Bandara”, “we”, “us” or “our” mean <?php echo e($company['legal_name']); ?>. “Customer” includes a B2C consumer and, where applicable, an approved B2B buyer.</p>
                ...
                <section id="credit" class="scroll-mt-28">
                    ...
                    <p>Current tiers are Silver (₹<?php echo e(number_format($rewards['silver_min'])); ?>–₹<?php echo e(number_format($rewards['silver_max'])); ?>), Gold (₹<?php echo e(number_format($rewards['gold_min'])); ?>–₹<?php echo e(number_format($rewards['gold_max'])); ?>) and Platinum (₹<?php echo e(number_format($rewards['platinum_min'])); ?> and above), assessed using the applicable rolling eligible-spend rules.</p>
                ...
                <section id="grievance" class="scroll-mt-28">
                    ...
                    <p>Raise an order, payment, delivery, account or product concern first with Customer Support at <a href="mailto:<?php echo e($company['support_email']); ?>" class="underline underline-offset-4"><?php echo e($company['support_email']); ?></a> or <?php echo e($company['support_phone']); ?> during <?php echo e($company['support_hours']); ?>.</p>
                    <p>An unresolved matter may be escalated to <strong class="font-normal text-slate-900 dark:text-slate-100"><?php echo e($company['grievance']['name']); ?>, <?php echo e($company['grievance']['designation']); ?></strong> at <a href="mailto:<?php echo e($company['grievance']['email']); ?>" class="underline underline-offset-4"><?php echo e($company['grievance']['email']); ?></a>. Include the order number, account contact, a clear description and supporting material.</p>
                ...
                <section id="changes" class="scroll-mt-28">
                    ...
                    <div class="mt-6 rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900/70">
                        <p><strong class="font-normal text-slate-900 dark:text-slate-100"><?php echo e($company['legal_name']); ?></strong><br><?php echo e($company['registered_address']); ?><br>GSTIN: <?php echo e($company['gstin']); ?><br>FSSAI licence: <?php echo e($company['fssai']); ?></p>
                    </div>
                    <p class="mt-5">For a quick explanation, visit <a href="<?php echo e(route('content.help')); ?>" class="underline underline-offset-4">Help & FAQs</a>. Personal-data practices are explained in the <a href="<?php echo e(route('content.privacy')); ?>" class="underline underline-offset-4">Privacy Policy</a>.</p>
                </section>
            </article>
        </div>
    </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/pages/terms.blade.php ENDPATH**/ ?>
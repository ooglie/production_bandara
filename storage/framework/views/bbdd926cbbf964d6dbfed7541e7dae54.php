<?php $__env->startSection('title', 'Inventory Lot #' . $lot->id); ?>
...
<div class="max-w-5xl mx-auto px-4 py-5 text-xs space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
            <h1 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-50">
                Inventory Lot #<?php echo e($lot->id); ?>

            </h1>
            <p class="text-[11px] text-gray-500 dark:text-gray-400">
                <?php echo e($product?->name ?? ('Product #' . $lot->product_id)); ?>

                <?php if($variant): ?>
                    · <?php echo e($variant->sku ?? ('Variant #' . $variant->id)); ?>
    ...
    <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3">
            ...
            <div class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($mode === 'pieces' ? 'Pieces' : 'Quantity'); ?></div>
        </div>
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3">
            <div class="text-[10px] uppercase tracking-wide text-gray-400">Batch</div>
            <div class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($lot->batch_code ?? '—'); ?></div>
        </div>
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3">
            <div class="text-[10px] uppercase tracking-wide text-gray-400">Received</div>
            <div class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($lot->received_date ?? '—'); ?></div>
        </div>
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3">
            <div class="text-[10px] uppercase tracking-wide text-gray-400">Expiry</div>
            <div class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($lot->expiry_date ?? '—'); ?></div>
        </div>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
        ...
        <dl class="grid gap-px bg-gray-100 dark:bg-gray-800 sm:grid-cols-2 lg:grid-cols-3 text-[11px]">
            <div class="bg-white dark:bg-gray-900 px-4 py-3">
                ...
                <dd class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($fmt($lot->received_quantity ?? 0, 3)); ?></dd>
            </div>
            <div class="bg-white dark:bg-gray-900 px-4 py-3">
                <dt class="text-gray-500 dark:text-gray-400">Consumed quantity</dt>
                <dd class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($fmt($consumedQty, 3)); ?></dd>
            </div>
            <div class="bg-white dark:bg-gray-900 px-4 py-3">
                <dt class="text-gray-500 dark:text-gray-400">Remaining quantity</dt>
                <dd class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($remaining !== null ? $fmt($remaining, 3) : '—'); ?></dd>
            </div>
            <div class="bg-white dark:bg-gray-900 px-4 py-3">
                <dt class="text-gray-500 dark:text-gray-400">Total weight</dt>
                <dd class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($lot->total_weight_kg !== null ? $fmt($lot->total_weight_kg, 3) . ' kg' : '—'); ?></dd>
            </div>
            <div class="bg-white dark:bg-gray-900 px-4 py-3">
                <dt class="text-gray-500 dark:text-gray-400">Available pieces</dt>
                <dd class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($availablePieces ?? '—'); ?></dd>
            </div>
            <div class="bg-white dark:bg-gray-900 px-4 py-3">
                <dt class="text-gray-500 dark:text-gray-400">Available weight</dt>
                <dd class="mt-1 font-semibold text-gray-900 dark:text-gray-50"><?php echo e($availableKg !== null ? $fmt($availableKg, 3) . ' kg' : ($lot->available_weight_kg !== null ? $fmt($lot->available_weight_kg, 3) . ' kg' : '—')); ?></dd>
            </div>
        </dl>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3">
        ...
        <p class="text-gray-600 dark:text-gray-300 whitespace-pre-line"><?php echo e($lot->notes ?: 'No notes recorded.'); ?></p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/inventory/lots/show.blade.php ENDPATH**/ ?>
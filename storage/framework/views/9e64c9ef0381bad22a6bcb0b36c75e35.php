...
<body>
    <main class="bandara-error" role="main">
        <span class="eyebrow">503 · Maintenance</span>
        <h1>We are updating Bandara.</h1>
        <p>The site is temporarily unavailable while we make improvements. Please check back shortly.</p>
        <div class="actions">
...
<?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/errors/503.blade.php ENDPATH**/ ?>
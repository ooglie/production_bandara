...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a
            href="<?php echo e(route('admin.announcements.create')); ?>"
                            ...
                            <tr class="align-top">
                                <td class="px-4 py-4">
                                    ...
                                    <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        <?php echo e($announcement->label ?: ucfirst($announcement->type)); ?>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-600 dark:text-gray-300">
                                    <div>
                                        ...
                                        <?php echo e($announcement->starts_at ? $announcement->starts_at->format('d M Y, h:i A') : 'Immediate'); ?>

                                    </div>
                                    <div class="mt-1">
                                        <span class="font-medium">End:</span>
                                        <?php echo e($announcement->ends_at ? $announcement->ends_at->format('d M Y, h:i A') : 'No expiry'); ?>
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <?php if($announcement->show_on_home): ?>
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex items-center justify-end gap-2">
                                        <a
                                            href="<?php echo e(route('admin.announcements.edit', $announcement)); ?>"
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/announcements/index.blade.php ENDPATH**/ ?>
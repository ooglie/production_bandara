    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email', $subscriber->email ?? '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="name" value="<?php echo e(old('name', $subscriber->name ?? '')); ?>"
                       class="mt-1 w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]
                              focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-700"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid gap-4 md:grid-cols-3">
            <div>
                ...
                <?php $st = old('status', $defaultStatus); ?>
                <select name="status"
                        class="mt-1 w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]
                               focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-700">
                    <option value="pending" <?php if($st==='pending'): echo 'selected'; endif; ?>>Pending</option>
                    <option value="active" <?php if($st==='active'): echo 'selected'; endif; ?>>Active</option>
                    <option value="unsubscribed" <?php if($st==='unsubscribed'): echo 'selected'; endif; ?>>Unsubscribed</option>
                    <option value="bounced" <?php if($st==='bounced'): echo 'selected'; endif; ?>>Bounced</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="source" value="<?php echo e(old('source', $subscriber->source ?? 'admin')); ?>"
                       class="mt-1 w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]
                              focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-700"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="datetime-local" name="confirmed_at"
                       value="<?php echo e($confirmedAtValue); ?>"
                       class="mt-1 w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]
                              focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-700">
                <p class="mt-1 text-[11px] text-gray-500 dark:text-gray-400">
                    Leave blank to keep unconfirmed (useful for pending).
                </p>
                <?php $__errorArgs = ['confirmed_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-[11px] text-red-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="flex items-center justify-between">
        ...
        <button type="submit"
            ...
            <?php echo e($isEdit ? 'Update subscriber' : 'Save subscriber'); ?>

        </button>
    </div>
</form><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/newsletter_subscribers/_form.blade.php ENDPATH**/ ?>
...
<form method="POST" action="<?php echo e($action); ?>" enctype="multipart/form-data" class="space-y-4">
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 space-y-4 text-xs">
        ...
        <div>
            ...
            <input type="text" name="short_description"
                   value="<?php echo e(old('short_description', $english('short_description'))); ?>"
                   class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2">
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2"><?php echo e(old('description', $english('description'))); ?></textarea>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <textarea name="ingredients_text" rows="8"
                          class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2"
                          placeholder="500g pork belly&#10;1 tsp salt&#10;1 tsp pepper"><?php echo e($ingredientsText); ?></textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="steps_text" rows="8"
                          class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2"
                          placeholder="Score the skin&#10;Season well&#10;Roast for 45 minutes"><?php echo e($stepsText); ?></textarea>
            </div>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-4">
            ...
            <div>
                ...
                <input type="number" min="0" name="sort_order"
                       value="<?php echo e(old('sort_order', $recipe->sort_order ?? 0)); ?>"
                       class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2">
            </div>
        </div>
                ...
                <?php if($videoPreviewUrl): ?>
                    <div class="mt-2">
                        ...
                        <video controls class="mt-1 max-h-44 w-full rounded border border-gray-200 dark:border-gray-800 bg-black">
                            <source src="<?php echo e($videoPreviewUrl); ?>">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <label class="flex items-start gap-2">
                        <input type="checkbox" name="product_ids[]"
                               ...
                               <?php if(in_array((int)$product->id, $selectedProductIds, true)): echo 'checked'; endif; ?>>
        ...
        <div>
            <label class="inline-flex items-center gap-2 text-[11px] text-gray-700 dark:text-gray-300">
                ...
                <input type="checkbox" name="is_active" value="1"
                       <?php if(old('is_active', $recipe->is_active ?? true)): echo 'checked'; endif; ?>>
                <span>Active</span>
            </label>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between">
        ...
        <button type="submit"
            ...
            <?php echo e($isEdit ? 'Update recipe' : 'Create recipe'); ?>

        </button>
    </div>
</form><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/recipes/_form.blade.php ENDPATH**/ ?>
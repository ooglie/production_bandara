<?php $__env->startSection('title', 'Edit Customer Price'); ?>
...
<div class="max-w-4xl mx-auto px-4 py-5 text-xs space-y-4">
    ...
    <form method="POST" action="<?php echo e(route('admin.b2b.prices.update', [$user, $price])); ?>"
                ...
                <select name="product_id" id="product_id"
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->id); ?>"
                            <?php if((int)old('product_id', $price->product_id) === (int)$p->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="date" name="valid_from"
                       value="<?php echo e(old('valid_from', optional($price->valid_from)->format('Y-m-d'))); ?>"
                       class="w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-2 py-2 text-[11px]">
            </div>
            ...
            <div>
                ...
                <input type="date" name="valid_to"
                       value="<?php echo e(old('valid_to', optional($price->valid_to)->format('Y-m-d'))); ?>"
                       class="w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-2 py-2 text-[11px]">
            </div>
        </div>
        ...
        <div class="flex items-center gap-2">
            <label class="inline-flex items-center gap-2 text-[11px] text-gray-700 dark:text-gray-200">
                <input type="checkbox" name="is_active" value="1" <?php if(old('is_active', (bool)$price->is_active)): echo 'checked'; endif; ?>>
                <span>Active</span>
            </label>

            <input type="hidden" name="currency" value="<?php echo e(old('currency', $price->currency ?? 'INR')); ?>">
        </div>
...
(function () {
    ...
    const selectedVariantId = <?php echo json_encode(old('product_variant_id', $price->product_variant_id), 512) ?>;
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/b2b/prices/edit.blade.php ENDPATH**/ ?>
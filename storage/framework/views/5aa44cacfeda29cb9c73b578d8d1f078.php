<?php $__env->startSection('title', 'Pay for Order ' . $order->order_number); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                Order <?php echo e($order->order_number); ?> • Amount payable ₹<?php echo e(number_format($order->grand_total, 2)); ?>
        ...
        <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-5 py-5 space-y-4">
            ...
            <div class="rounded-sm border border-sky-200 dark:border-sky-900/40 bg-sky-50/80 dark:bg-sky-950/20 px-4 py-4">
                <div class="text-sm font-medium text-sky-800 dark:text-sky-200">
                    Stock hold: about <?php echo e($stockHoldMinutesLabel); ?> minute<?php echo e($stockHoldMinutesLabel === 1 ? '' : 's'); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var options = {
            ...
            timeout: <?php echo e(max(60, min((int) ($reservationTimeoutSeconds ?? 300), 600))); ?>,
            prefill: {
            ...
            handler: function (response) {
                ...
                fetch("<?php echo e(route('payment.razorpay.callback')); ?>", {
                    method: "POST",
                    headers: {
                ...
                .catch(function (error) {
                    ...
                    setTimeout(function () { window.location.href = "<?php echo e(route('orders.show', $order)); ?>"; }, 900);
                });
            },
            modal: {
                ondismiss: function () {
                    if (isVerifying) return;
                    window.location.href = "<?php echo e(route('orders.show', $order)); ?>";
                }
            }
        };
        ...
        function openCheckout() {
            ...
            rzp.on('payment.failed', function (response) {
                ...
                fetch("<?php echo e(route('payment.razorpay.failed')); ?>", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "Accept": "application/json",
                    ...
                    body: JSON.stringify({
                        razorpay_order_id: "<?php echo e($razorpayOrderId); ?>",
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/customer/payments/razorpay.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Edit B2B Product'); ?>
...
<div class="max-w-4xl mx-auto px-4 py-6 text-xs space-y-4">
    ...
    <form method="POST" action="<?php echo e(route('admin.customers.b2b-products.update', [$user, $row])); ?>" class="space-y-3">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <?php echo $__env->make('admin.customers.b2b-products._form', ['user' => $user, 'row' => $row, 'products' => collect()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/customers/b2b-products/edit.blade.php ENDPATH**/ ?>
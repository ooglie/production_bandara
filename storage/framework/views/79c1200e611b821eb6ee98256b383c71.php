            ...
            <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <div class="flex flex-1 flex-col p-4">
                        <?php if($cardEyebrow): ?>
                            <div class="text-[10px] uppercase tracking-[0.14em] text-gray-400 dark:text-gray-500"><?php echo e($cardEyebrow); ?></div>
                        <?php endif; ?>

                        <div class="mt-1 text-sm font-semibold text-gray-900 dark:text-gray-50"><?php echo e($cardTitle); ?></div>

                        <?php if($cardDescription): ?>
                            <p class="mt-1 line-clamp-2 text-xs leading-5 text-gray-600 dark:text-gray-300"><?php echo e($cardDescription); ?></p>
                        <?php endif; ?>
                        ...
                        <div class="mt-auto flex items-center justify-between gap-3 border-t border-gray-100 pt-3 text-[11px] dark:border-gray-800">
                            <span class="text-gray-500 dark:text-gray-400">
                                <?php if(! is_null($productCount)): ?>
                                    <?php echo e($productCount); ?> <?php echo e(Str::plural('product', (int) $productCount)); ?>

...
<form method="POST" action="<?php echo e($action); ?>" class="space-y-4">
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 space-y-4 text-xs">
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="key" required
                       value="<?php echo e(old('key', $page->key ?? '')); ?>"
            ...
            <div>
                ...
                <input type="text" name="title" required
                       value="<?php echo e(old('title', $english('title'))); ?>"
                       class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" name="slug"
                   value="<?php echo e(old('slug', $english('slug'))); ?>"
        ...
        <div>
            ...
            <textarea name="excerpt" rows="3"
                      class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2"><?php echo e(old('excerpt', $english('excerpt'))); ?></textarea>
        </div>

        <div>
            <label class="block text-[11px] font-medium text-gray-700 dark:text-gray-300">Content</label>
            <textarea name="content" rows="10"
                      class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2"><?php echo e(old('content', $english('content'))); ?></textarea>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="meta_title"
                       value="<?php echo e(old('meta_title', $english('meta_title'))); ?>"
                       class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2">
            </div>
            ...
            <div>
                ...
                <textarea name="meta_description" rows="3"
                          class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2"><?php echo e(old('meta_description', $english('meta_description'))); ?></textarea>
            </div>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <input type="number" min="0" name="sort_order"
                       value="<?php echo e(old('sort_order', $page->sort_order ?? 0)); ?>"
                       class="mt-1 w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2">
            </div>
            ...
            <div class="flex items-end">
                <label class="inline-flex items-center gap-2 text-[11px] text-gray-700 dark:text-gray-300">
                    ...
                    <input type="checkbox" name="is_active" value="1"
                           <?php if(old('is_active', $page->is_active ?? true)): echo 'checked'; endif; ?>>
                    <span>Active</span>
                </label>
            </div>
        </div>
    ...
    <div class="flex items-center justify-between">
        ...
        <button type="submit"
            ...
            <?php echo e($isEdit ? 'Update page' : 'Create page'); ?>

        </button>
    </div>
</form><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/pages/_form.blade.php ENDPATH**/ ?>
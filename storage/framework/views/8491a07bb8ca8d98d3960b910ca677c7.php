            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/40">
                        ...
                        <td class="px-4 py-3 text-right text-gray-700 dark:text-gray-200"><?php echo e($row['quantity'] ?: '—'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-700 dark:text-gray-200"><?php echo e($row['weight_kg'] ?: '—'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-700 dark:text-gray-200"><?php echo e($row['pieces'] ?: '—'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-700 dark:text-gray-200"><?php echo e($row['packs'] ?: '—'); ?></td>

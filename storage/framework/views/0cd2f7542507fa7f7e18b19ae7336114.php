                        ...
                        <div class="space-y-3">
                            <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/40 px-4 py-3">
                                ...
                                <div class="mt-1 text-sm font-medium text-gray-900 dark:text-gray-50">
                                    <?php echo e($user->name ?: 'Not added'); ?>
                            ...
                            <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/40 px-4 py-3">
                                ...
                                <div class="mt-1 text-sm font-medium text-gray-900 dark:text-gray-50 break-all">
                                    <?php echo e($user->email ?: 'Not added'); ?>
                            ...
                            <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/40 px-4 py-3">
                                ...
                                <div class="mt-1 text-sm font-medium text-gray-900 dark:text-gray-50">
                                    <?php echo e($user->phone ?: 'Not added'); ?>
                ...
                <div class="p-4 sm:p-6 lg:p-7 space-y-5">
                    ...
                    <div class="grid gap-5 xl:grid-cols-2">
                        ...
                        <section class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
                            ...
                            <form method="POST" action="<?php echo e(route('account.profile.update')); ?>" enctype="multipart/form-data" class="px-5 py-5 space-y-4">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
                            ...
                            <form method="POST" action="<?php echo e(route('account.profile.password')); ?>" class="px-5 py-5 space-y-4" >
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/account/profile.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Bandara Credit rules'); ?>
...
<div class="max-w-5xl mx-auto px-4 py-6 space-y-5">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <?php if(Route::has('account.rewards')): ?>
            <a href="<?php echo e(route('account.rewards')); ?>" class="inline-flex rounded-sm border border-gray-300 px-4 py-2 text-xs text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
                Back to rewards
            </a>
        <?php endif; ?>
    </div>
    ...
    <div class="grid gap-4 lg:grid-cols-2">
                ...
                <table class="min-w-full text-xs">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        <?php $__empty_1 = true; $__currentLoopData = $tiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="py-2 pr-3 font-medium text-gray-900 dark:text-gray-50"><?php echo e($tier['name'] ?? str($tier['key'] ?? 'tier')->title()); ?></td>
                                <td class="py-2 pr-3 text-gray-600 dark:text-gray-300">
                                    <?php echo e(number_format((int) ($tier['threshold_min'] ?? 0))); ?><?php echo e(isset($tier['threshold_max']) && $tier['threshold_max'] !== null ? '–'.number_format((int) $tier['threshold_max']) : '+'); ?>

                                </td>
                                <td class="py-2 text-right text-gray-900 dark:text-gray-50"><?php echo e(rtrim(rtrim(number_format((float) ($tier['reward_rate_percent'] ?? 0), 2), '0'), '.')); ?>%</td>
                            </tr>
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
            ...
            <ul class="mt-3 space-y-2 text-xs text-gray-600 dark:text-gray-300">
                ...
                <li>• Minimum redemption: <?php echo e(number_format($minimumRedeemPoints)); ?> point<?php echo e($minimumRedeemPoints === 1 ? '' : 's'); ?>.</li>
                <li>• Maximum redemption per order: <?php echo e(rtrim(rtrim(number_format($maxOrderPercent, 2), '0'), '.')); ?>% of eligible order value.</li>
                <li>• Reserved credits are held while payment is pending and released if checkout/payment fails.</li>
                <li>• At least ₹<?php echo e(number_format($minimumPayableAmount, 2)); ?> must remain payable unless a separate fully credit-paid checkout flow is enabled later.</li>
            </ul>
        </section>
    </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/customer/account/reward-terms.blade.php ENDPATH**/ ?>
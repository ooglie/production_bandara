    ...
    <div class="grid gap-4 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
            <form id="checkout-bulk-remove-form"
                  method="POST"
                  action="<?php echo e($cartBulkDestroyUrl); ?>"
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="text-gray-700 dark:text-gray-200">
                            <td class="px-4 py-2 whitespace-nowrap align-top">
                                <div class="flex items-center gap-2">
                                    <input type="checkbox"
                                           ...
                                           class="rounded border-gray-300 dark:border-gray-700"
                                           aria-label="Select <?php echo e($p?->name ?? 'product'); ?> for removal">
                                    <span class="text-[10px] text-gray-500 dark:text-gray-400"><?php echo e($loop->iteration); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-2">
                                ...
                                <?php if($variantLabel): ?>
                                    <div class="mt-1 text-[10px] text-gray-500 dark:text-gray-400"><?php echo e($variantLabel); ?></div>
                                <?php endif; ?>

                                <div class="text-[10px] text-gray-500 dark:text-gray-400">
                                    <?php if(!$isB2BCheckoutUser && !empty($p?->product_weight)): ?>
                                        Pack wt: <?php echo e($fmtW($p->product_weight)); ?>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">
                                <?php echo e($isKg ? $fmtQty($qty) : (int) $qty); ?> <?php echo e($unitLabel($sellUnit)); ?>

                            </td>

                            <?php if(!$isB2BCheckoutUser): ?>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <?php echo e($fmtW($lineWeight)); ?>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap text-right">
                                <form method="POST"
                                      action="<?php echo e($cartDestroyUrl($it->id)); ?>"
        ...
        <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 space-y-3">
            ...
            <?php if($placeUrl): ?>
                <form method="POST" action="<?php echo e($placeUrl); ?>" class="space-y-3" data-checkout-form>
                    <?php echo csrf_field(); ?>
                ...
                <label class="block cursor-pointer rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950/40 px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-900">
                    <div class="flex items-start gap-3">
                        <input
                            ...
                            <?php if((int) old('address_id', $selectedAddressId) === (int) $address->id): echo 'checked'; endif; ?>
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="mt-1 text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
                                ...
                                <br>
                                <?php echo e($address->country ?? 'India'); ?>
                                    ...
                                    <label class="block cursor-pointer rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950/40 px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-900">
                                        <div class="flex items-start gap-3">
                                            <input
                                                ...
                                                class="mt-1 rounded border-gray-300 dark:border-gray-700"
                                                <?php if((int) old('billing_address_id', $selectedBillingAddressId) === (int) $billingOption->id): echo 'checked'; endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <textarea name="customer_note"
                              ...
                              class="w-full rounded-sm border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-2 py-2 text-[11px]"><?php echo e(old('customer_note')); ?></textarea>

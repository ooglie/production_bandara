<?php $__env->startSection('title', 'New vendor invoice'); ?>
...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            <a href="<?php echo e($backUrl); ?>" class="text-[12px] px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">Back</a>
            <?php if($has('admin.products.create')): ?>
                <a href="<?php echo e(route('admin.products.create')); ?>" target="_blank" class="text-[12px] px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">New product</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e($storeUrl); ?>" class="space-y-4" id="vendor-invoice-form">
        <?php echo csrf_field(); ?>
        ...
        <section class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
            ...
            <div class="p-5 grid gap-4 md:grid-cols-4">
                <div>
                    ...
                    <select name="vendor_id" required class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]">
                        ...
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($v->id); ?>" <?php if((int) old('vendor_id', $vendor?->id ?? 0) === (int) $v->id): echo 'selected'; endif; ?>>
                                <?php echo e(trim(($v->code ? $v->code . ' — ' : '') . $v->name)); ?>
                ...
                <div>
                    ...
                    <input type="text" name="invoice_number" value="<?php echo e(old('invoice_number')); ?>" required class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]">
                </div>
                <div>
                    <label class="block text-[12px] font-medium text-gray-700 dark:text-gray-300 mb-1">Invoice date</label>
                    <input type="date" name="invoice_date" value="<?php echo e(old('invoice_date', now()->format('Y-m-d'))); ?>" required class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]">
                </div>
                <div>
                    <label class="block text-[12px] font-medium text-gray-700 dark:text-gray-300 mb-1">Due date</label>
                    <input type="date" name="due_date" value="<?php echo e(old('due_date')); ?>" class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]">
                </div>
                <div class="md:col-span-4">
                    <label class="block text-[12px] font-medium text-gray-700 dark:text-gray-300 mb-1">Notes</label>
                    <input type="text" name="notes" value="<?php echo e(old('notes')); ?>" placeholder="Optional" class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]">
                </div>
            </div>
        </section>
        ...
        <div class="flex justify-end gap-3">
            <a href="<?php echo e($backUrl); ?>" class="rounded-lg border border-gray-300 dark:border-gray-700 px-4 py-2 text-[12px] hover:bg-gray-50 dark:hover:bg-gray-800">Cancel</a>
        ...
        <div class="grid gap-3 lg:grid-cols-12">
                ...
                <select class="product-select w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]" name="items[__INDEX__][product_id]" required>
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->id); ?>">
                            <?php echo e($p->name); ?> <?php if($p->sku): ?> (<?php echo e($p->sku); ?>) <?php endif; ?> <?php if (! ($p->is_active)): ?> — Internal/Draft <?php endif; ?>
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="lg:col-span-3">
                ...
                <select class="hsn-select hidden mt-2 w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[13px]">
                    ...
                    <?php $__currentLoopData = $hsnCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($h->id); ?>"><?php echo e($h->code); ?> — <?php echo e($h->description ?: $h->name); ?> (<?php echo e(number_format((float) $h->gst_rate, 2)); ?>%)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
(function () {
    ...
    const productMeta = <?php echo json_encode($productMeta, 15, 512) ?>;
    const variantMeta = <?php echo json_encode($variantMeta, 15, 512) ?>;
    const hsnMeta = <?php echo json_encode($hsnMeta, 15, 512) ?>;
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/vendor_invoices/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'New vendor payment'); ?>
...
<div class="max-w-4xl mx-auto px-4 py-6 text-xs space-y-4">
    ...
    <form method="POST" action="<?php echo e(route('admin.vendor-payments.store')); ?>" class="space-y-3">
        <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="vendor_id" required
                        ...
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($v->id); ?>" <?php if(old('vendor_id', $selectedVendor?->id ?? null) == $v->id): echo 'selected'; endif; ?>>
                                <?php echo e($v->name); ?>
                    ...
                    <select name="vendor_invoice_id" id="vendor-invoice-select"
                        ...
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option value="<?php echo e($inv->id); ?>"
                                    data-outstanding="<?php echo e(number_format($outstanding, 2, '.', '')); ?>"
                                    <?php if(old('vendor_invoice_id', $selectedInvoice?->id ?? null) == $inv->id): echo 'selected'; endif; ?>>
                                <?php echo e($inv->invoice_number); ?> · <?php echo e($inv->vendor?->name); ?> · Outstanding ₹<?php echo e(number_format($outstanding, 2)); ?> (Adjusted ₹<?php echo e(number_format($adjusted, 2)); ?>, Paid ₹<?php echo e(number_format($paid, 2)); ?>)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="grid gap-3 md:grid-cols-3">
                <div>
                    ...
                    <input type="number" step="0.01" min="0.01" name="amount" id="vendor-payment-amount" required
                           value="<?php echo e(old('amount', $selectedOutstanding !== null && $selectedOutstanding > 0 ? number_format($selectedOutstanding, 2, '.', '') : '')); ?>"
                           class="w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-gray-400 dark:focus:ring-gray-500">
        ...
        <div class="flex items-center justify-between pt-2">
            <a href="<?php echo e(route('admin.vendor-payments.index')); ?>" class="text-[11px] text-gray-500 dark:text-gray-400 hover:underline">Cancel</a>
            <button type="submit"
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/vendor_payments/create.blade.php ENDPATH**/ ?>
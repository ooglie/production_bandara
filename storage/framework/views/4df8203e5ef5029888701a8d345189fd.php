...
<?php $__env->startSection('breadcrumb', 'Admin · Finance'); ?>
...
<div class="space-y-4">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <form method="GET" action="<?php echo e(route('admin.finance.index')); ?>" class="flex items-end gap-2 text-xs">
            <div>
                <label for="finance-month" class="block text-[11px] font-medium text-gray-600 dark:text-gray-300">Month</label>
                <input id="finance-month" type="month" name="month" value="<?php echo e($month->format('Y-m')); ?>"
    ...
    <section class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-950">
        <div class="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between">
            <div>
                ...
                <h2 class="mt-1 text-sm font-semibold text-gray-900 dark:text-gray-50"><?php echo e($summary['month_label']); ?></h2>
        ...
        <div class="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
            <div class="rounded border border-gray-100 p-3 dark:border-gray-800">
                ...
                <div class="mt-1 text-xl font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format($summary['revenue_collected'], 2)); ?></div>
            ...
            <div class="rounded border border-gray-100 p-3 dark:border-gray-800">
                ...
                <div class="mt-1 text-xl font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format($summary['supplier_purchases'], 2)); ?></div>
                <div class="mt-1 text-[10px] text-gray-400">Non-cancelled vendor invoices by invoice date.</div>
            </div>
            <?php if($canViewSalaryAggregate): ?>
                <div class="rounded border border-gray-100 p-3 dark:border-gray-800">
                    <div class="text-[10px] uppercase tracking-wide text-gray-500">Salary expense</div>
                    <div class="mt-1 text-xl font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format($summary['salary_expense'], 2)); ?></div>
            ...
            <div class="rounded border border-gray-100 p-3 dark:border-gray-800">
                ...
                <div class="mt-1 text-xl font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format($summary['other_operating_expenses'], 2)); ?></div>
            ...
            <?php if($canViewSalaryAggregate): ?>
                <div class="rounded border border-gray-100 p-3 dark:border-gray-800">
                    ...
                    <div class="mt-1 text-xl font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format($summary['total_operating_outflow'], 2)); ?></div>
                ...
                <div class="rounded border border-gray-900 bg-gray-900 p-3 text-white dark:border-gray-100 dark:bg-gray-100 dark:text-gray-900">
                    ...
                    <div class="mt-1 text-xl font-semibold">₹<?php echo e(number_format($summary['provisional_operating_cash_balance'], 2)); ?></div>
        ...
        <div class="mt-3 grid gap-3 sm:grid-cols-3">
            <div class="rounded bg-gray-50 px-3 py-2.5 dark:bg-gray-900">
                ...
                <div class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-50"><?php echo e(number_format($summary['draft_expense_count'])); ?></div>
            </div>
            <div class="rounded bg-gray-50 px-3 py-2.5 dark:bg-gray-900">
                <div class="text-[11px] text-gray-500">Posted but unpaid expenses</div>
                <div class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-50"><?php echo e(number_format($summary['unpaid_expense_count'])); ?></div>
            </div>
            <?php if($canViewSalaryAggregate): ?>
                <div class="rounded bg-gray-50 px-3 py-2.5 dark:bg-gray-900">
                    <div class="text-[11px] text-gray-500">Pending or held salaries</div>
                    <div class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-50"><?php echo e(number_format($summary['pending_salary_count'])); ?></div>
                </div>
            <?php endif; ?>
        </div>
    </section>
    ...
    <div class="grid gap-4 xl:grid-cols-2">
            ...
            <section class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-950">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <div class="flex gap-2">
                        <?php if($canManageExpenses): ?>
                            <a href="<?php echo e(route('admin.finance.expenses.create')); ?>" class="rounded border border-gray-900 bg-gray-900 px-3 py-1.5 text-[11px] font-medium text-white dark:border-gray-100 dark:bg-gray-100 dark:text-gray-900">New</a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('admin.finance.expenses.index', ['month' => $month->format('Y-m')])); ?>" class="rounded border border-gray-300 px-3 py-1.5 text-[11px] text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-900">All</a>
                    </div>
                </div>
                <div class="mt-3 divide-y divide-gray-100 text-xs dark:divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $recentExpenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('admin.finance.expenses.show', $expense)); ?>" class="flex items-center justify-between gap-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                            <div class="min-w-0">
                                <div class="truncate font-medium text-gray-900 dark:text-gray-50"><?php echo e($expense->description); ?></div>
                                <div class="mt-0.5 text-[10px] text-gray-500"><?php echo e($expense->expense_date?->format('d M Y')); ?> · <?php echo e($expense->category?->name); ?> · <?php echo e(ucfirst($expense->record_status)); ?></div>
                            </div>
                            <div class="shrink-0 font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format((float) $expense->total_amount, 2)); ?></div>
                        </a>
        ...
        <?php if($canViewSalaryRecords): ?>
            <section class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-950">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-50">Salary records</h2>
                        <p class="mt-1 text-[11px] text-gray-500 dark:text-gray-400">Restricted payroll details for <?php echo e($summary['month_label']); ?>.</p>
                    </div>
                    <a href="<?php echo e(route('admin.finance.salary-entries.index', ['month' => $month->format('Y-m')])); ?>" class="rounded border border-gray-300 px-3 py-1.5 text-[11px] text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-900">Open</a>
                </div>
                <div class="mt-3 divide-y divide-gray-100 text-xs dark:divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $recentSalaryEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('admin.finance.salary-entries.show', $entry)); ?>" class="flex items-center justify-between gap-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                            <div class="min-w-0">
                                <div class="truncate font-medium text-gray-900 dark:text-gray-50"><?php echo e($entry->staff_name); ?></div>
                                <div class="mt-0.5 text-[10px] text-gray-500"><?php echo e(\App\Models\SalaryEntry::paymentStatuses()[$entry->payment_status] ?? ucfirst($entry->payment_status)); ?></div>
                            </div>
                            <div class="shrink-0 font-semibold text-gray-900 dark:text-gray-50">₹<?php echo e(number_format((float) $entry->net_payable, 2)); ?></div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <?php elseif($canViewSalaryAggregate): ?>
            <section class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-950">
    ...
    <?php if($summary['category_breakdown'] !== []): ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-xs">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        <?php $__currentLoopData = $summary['category_breakdown']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-3 py-2 text-gray-700 dark:text-gray-200"><?php echo e($row['name']); ?></td>
                                <td class="px-3 py-2 text-right font-medium text-gray-900 dark:text-gray-50">₹<?php echo e(number_format($row['total'], 2)); ?></td>
                            </tr>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/finance/index.blade.php ENDPATH**/ ?>
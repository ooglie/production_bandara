<?php $__env->startSection('title', 'Edit B2C Customer'); ?>
...
<div class="max-w-2xl mx-auto px-4 py-6 space-y-4">
    ...
    <?php if($canDelete): ?>
        <div class="pt-1 flex justify-end">
            <form method="POST" action="<?php echo e($destroyUrl); ?>" onsubmit="return confirm('Delete this customer?');">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/customers/b2c/edit.blade.php ENDPATH**/ ?>
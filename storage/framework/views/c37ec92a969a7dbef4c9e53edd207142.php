...
<div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 space-y-3">
    ...
    <form method="GET" action="<?php echo e(url()->current()); ?>" class="flex flex-col sm:flex-row gap-2 sm:items-center">
        <div class="flex-1">
            <input type="text" name="b2b_q" value="<?php echo e($q); ?>"
    ...
    <?php else: ?>
        ...
        <form method="POST" action="<?php echo e(route('dashboard.b2b.quickAdd')); ?>" class="space-y-3">
            <?php echo csrf_field(); ?>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/40">
                            <td class="px-3 py-2 align-top">
                                <input type="checkbox"
                                       ...
                                       name="lines[<?php echo e($rowIndex); ?>][enabled]"
                                       value="1">
                                <input type="hidden" name="lines[<?php echo e($rowIndex); ?>][product_id]" value="<?php echo e($pid); ?>">
                            </td>

                            <td class="px-3 py-2 align-top text-gray-900 dark:text-gray-50">
                                <div class="font-medium"><?php echo e($p->name); ?></div>
                                <?php if(!empty($p->sku)): ?>
                                    <div class="text-[10px] text-gray-400"><?php echo e($p->sku); ?></div>
                                <?php endif; ?>
                            </td>

                            <td class="px-3 py-2 align-top">
                                <?php if($isVariable): ?>
                                    <select name="lines[<?php echo e($rowIndex); ?>][product_variant_id]"
                                            ...
                                            data-price-target="b2b-price-<?php echo e($rowIndex); ?>">
                                        ...
                                        <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <option value="<?php echo e($vId); ?>" data-price="<?php echo e(number_format($vPrice, 2, '.', '')); ?>">
                                                <?php echo e($vLabel); ?>
                            ...
                            <td class="px-3 py-2 align-top text-gray-700 dark:text-gray-200">
                                <?php echo e(rtrim(rtrim(number_format($moq, 2), '0'), '.')); ?>

                            </td>

                            <td class="px-3 py-2 align-top text-gray-900 dark:text-gray-50">
                                <span id="b2b-price-<?php echo e($rowIndex); ?>"><?php echo e($priceLabel); ?></span>
                            </td>

                            <td class="px-3 py-2 align-top">
                                <input type="number"
                                       step="0.01"
                                       min="<?php echo e(number_format($moq, 2, '.', '')); ?>"
                                       name="lines[<?php echo e($rowIndex); ?>][quantity]"
                                       value="<?php echo e(number_format($moq, 2, '.', '')); ?>"
...
<?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/dashboard/partials/b2b_quick_order.blade.php ENDPATH**/ ?>
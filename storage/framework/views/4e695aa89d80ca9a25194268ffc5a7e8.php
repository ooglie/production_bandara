...
<form id="<?php echo e($isEdit ? 'ticket-category-edit-form' : 'ticket-category-create-form'); ?>"
      method="POST"
        ...
        <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 px-3 py-2 w-full sm:w-auto">
                    <label class="inline-flex items-center gap-2 text-[12px] text-gray-800 dark:text-gray-200">
                        ...
                        <input type="checkbox" name="is_active" value="1"
                               <?php if(old('is_active', $category->is_active ?? 1)): echo 'checked'; endif; ?>
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="description"
                          rows="4"
                          class="w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-3 py-2 text-[12px]
                                 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-700"><?php echo e(old('description', $category->description ?? '')); ?></textarea>
            </div>
        </div>
    </div>
...
</form><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/admin/ticket-categories/_form.blade.php ENDPATH**/ ?>
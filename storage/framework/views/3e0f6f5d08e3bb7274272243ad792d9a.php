<?php $__env->startSection('title', 'Pay invoice ' . $invoice->invoice_number); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
            ...
            <h1 class="mt-3 text-2xl font-semibold text-gray-900 dark:text-gray-50">
                <?php echo e($isPartial ? 'Make part payment' : 'Pay invoice balance'); ?>

            </h1>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                Invoice <?php echo e($invoice->invoice_number); ?> • Paying ₹<?php echo e(number_format($amountToPay, 2)); ?>
        ...
        <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-5 py-5 space-y-4">
            ...
            <div class="rounded-sm border border-gray-200 dark:border-gray-800 bg-gray-50/70 dark:bg-gray-950/40 px-4 py-4 space-y-3">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <span class="inline-flex items-center rounded-sm border px-2.5 py-0.5 text-[10px] font-medium <?php echo e($invoiceStatusMeta['class']); ?>">
                        <?php echo e($invoiceStatusMeta['label']); ?>
                ...
                <div class="space-y-1 text-[11px] text-gray-700 dark:text-gray-300">
                    ...
                    <div class="flex justify-between gap-3">
                        ...
                        <span>₹<?php echo e(number_format($invoice->amount_paid, 2)); ?></span>
                    </div>
                    <div class="flex justify-between gap-3">
                    ...
                    <div class="flex justify-between gap-3 font-semibold text-gray-900 dark:text-gray-50 pt-2 border-t border-gray-200 dark:border-gray-800">
                        ...
                        <span>₹<?php echo e(number_format($amountToPay, 2)); ?></span>
                    </div>
                    <div class="flex justify-between gap-3 text-gray-500 dark:text-gray-400">
                        <span>Balance after success</span>
                        <span>₹<?php echo e(number_format(max(0, $balance - $amountToPay), 2)); ?></span>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var options = {
            ...
            amount: "<?php echo e($amountPaise); ?>",
            currency: "INR",
            name: "Frozen - Bandara",
            description: "Invoice <?php echo e($invoice->invoice_number); ?>",
            ...
            notes: {
                ...
                invoice_number: "<?php echo e($invoice->invoice_number); ?>",
                internal_order_id: "<?php echo e($order?->id); ?>"
            },
            theme: {
                color: "#111827"
            },
            handler: function (response) {
                ...
                fetch("<?php echo e(route('payment.razorpay.invoice-callback')); ?>", {
                    method: "POST",
                    headers: {
                ...
                .catch(function (error) {
                    ...
                    setTimeout(function () { window.location.href = "<?php echo e(route('invoices.show', $invoice)); ?>"; }, 900);
                });
            },
            modal: {
                ondismiss: function () {
                    if (isVerifying) return;
                    window.location.href = "<?php echo e(route('invoices.show', $invoice)); ?>";
                }
            }
        };
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/customer/payments/invoice-razorpay.blade.php ENDPATH**/ ?>
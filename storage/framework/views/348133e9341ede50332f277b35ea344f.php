...
<table class="brand-header">
    <tr>
        <td style="width: 20%;">
            <?php if(file_exists(public_path('storage/images/logo-bandara-print.png'))): ?>
                <img class="logo" src="<?php echo e(public_path('storage/images/logo-bandara-print.png')); ?>" alt="Bandara Logo">
            <?php endif; ?>
        </td>
...
<table class="header-table">
    <tr>
        <td style="width: 28%;">
            ...
            <table class="invoice-meta">
                <tr>
                    ...
                    <td><?php echo e($invoiceDate->format('F j, Y')); ?></td>
                </tr>
                <tr>
                ...
                <?php if($placeOfSupplyCode): ?>
                    <tr>
                        <td class="label">Place of Supply</td>
                        <td><?php echo e($placeOfSupplyState['name'] ?? '-'); ?> (<?php echo e($placeOfSupplyCode); ?>)</td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td class="label">Tax Mode</td>
                    <td><?php echo e($gstType === 'intra_state' ? 'CGST + SGST' : 'IGST'); ?></td>
                </tr>
                <?php if($isBillToShipTo): ?>
                    <tr>
                ...
                <?php if($invoice->due_date): ?>
                    <tr>
                        ...
                        <td><?php echo e($invoice->due_date->format('F j, Y')); ?></td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td class="label">Payment</td>
                    <td><?php echo e($invoice->payment_method_label); ?></td>
                </tr>
            </table>
        </td>
        ...
        <td style="width: 36%;">
            ...
            <div class="party-name"><?php echo e($billingName); ?></div>
            <div class="party-meta">
                GSTIN: <?php echo e($customerGstin ?: '-'); ?><br>
                FSSAI No: <?php echo e($customerFssai ?: '-'); ?>

            </div>
            <?php $__empty_1 = true; $__currentLoopData = $addressLines($billingAddress); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="party-address"><?php echo e($line); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="party-address">Billing address unavailable</div>
            <?php endif; ?>
            <?php if($billingAddress?->phone): ?>
                <div class="party-address">Phone: <?php echo e($billingAddress->phone); ?></div>
            <?php endif; ?>
        </td>

        <td style="width: 36%;">
            <div class="heading">SHIPPED TO</div>
            <div class="party-name"><?php echo e($shippingName); ?></div>
            <?php $__empty_1 = true; $__currentLoopData = $addressLines($shippingAddress); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="party-address"><?php echo e($line); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="party-address">Same as billing address</div>
            <?php endif; ?>
            <?php if($shippingAddress?->phone): ?>
                <div class="party-address">Phone: <?php echo e($shippingAddress->phone); ?></div>
            <?php endif; ?>
        </td>
    </tr>
</table>
...
<table class="items-table">
    ...
    <tbody>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <tr>
                <td class="sr"><?php echo e($count); ?></td>
                <td class="desc"><span class="line-description"><?php echo e($item->description); ?></span></td>
                <td class="hsn"><?php echo e($item->hsn_sac_code ?: '-'); ?></td>
                <td class="qty"><?php echo e($fmtQty($item->quantity)); ?></td>
                <td class="wt"><?php echo e($fmtWeight($item->item_weight)); ?></td>
                <td class="rate money">₹<?php echo e($fmtMoney($item->unit_price)); ?><span class="rate-unit">/<?php echo e($unit); ?></span></td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($item->subtotal)); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr>
        ...
        <?php if($deliveryFee > 0): ?>
            ...
            <tr>
                ...
                <td class="hsn"><?php echo e($deliverySacCode); ?></td>
                <td class="qty"></td>
                <td class="wt"></td>
                <td class="rate">Flat</td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($deliveryFee)); ?></td>
            </tr>
        <?php endif; ?>

        <?php if($coldChainFee > 0): ?>
            <?php $count++; ?>
            <tr>
                <td class="sr"><?php echo e($count); ?></td>
                <td class="desc"><span class="service-description">Cold Chain Fee</span></td>
                <td class="hsn"><?php echo e($handlingSacCode); ?></td>
                <td class="qty"></td>
                <td class="wt"></td>
                <td class="rate">Flat</td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($coldChainFee)); ?></td>
            </tr>
        <?php endif; ?>
        ...
        <?php if($discountTotal > 0): ?>
            <tr>
                ...
                <td class="amount-col money">- ₹<?php echo e($fmtMoney($discountTotal)); ?></td>
            </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td class="amount-col money">₹<?php echo e($fmtMoney($taxableSubtotal)); ?></td>
        </tr>

        <?php if($gstType === 'intra_state'): ?>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label">CGST</td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($cgst)); ?></td>
            </tr>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label">SGST</td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($sgst)); ?></td>
            </tr>
        <?php else: ?>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label">IGST</td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($igst)); ?></td>
            </tr>
        <?php endif; ?>

        <?php if($bandaraCreditRedeemed > 0): ?>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label">Bandara Credit</td>
                <td class="amount-col money">- ₹<?php echo e($fmtMoney($bandaraCreditRedeemed)); ?></td>
            </tr>
        <?php endif; ?>

        <?php if(abs($roundOff) >= 0.005): ?>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label">Round Off</td>
                <td class="amount-col money"><?php echo e($roundOff < 0 ? '- ' : ''); ?>₹<?php echo e($fmtMoney(abs($roundOff))); ?></td>
            </tr>
        <?php endif; ?>
        ...
        <tr class="summary-total">
            ...
            <td class="amount-col money">₹<?php echo e($fmtMoney($grandTotal)); ?></td>
        </tr>

        <?php if($paidAmount > 0 || $balanceAmount + 0.005 < $grandTotal): ?>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label">Paid</td>
                <td class="amount-col money">₹<?php echo e($fmtMoney($paidAmount)); ?></td>
            </tr>
            <tr>
                <td colspan="5"></td>
                <td class="summary-label"><strong>Balance Due</strong></td>
                <td class="amount-col money"><strong>₹<?php echo e($fmtMoney($balanceAmount)); ?></strong></td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>

<div class="amount-words"><?php echo e($amountWords); ?></div>

<?php if($taxSummaryRows->isNotEmpty()): ?>
    ...
    <?php if($gstType === 'intra_state'): ?>
        <table class="tax-table">
            ...
            <tbody>
                <?php $__currentLoopData = $taxSummaryRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="code"><?php echo e($row['hsn_sac_code']); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['taxable_value'])); ?></td>
                        <td><?php echo e($fmtPercent($row['cgst_rate'])); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['cgst_amount'])); ?></td>
                        <td><?php echo e($fmtPercent($row['sgst_rate'])); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['sgst_amount'])); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['total_tax'])); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr class="tax-total-row">
                    <td class="code">Total</td>
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['taxable_value'] ?? 0)); ?></td>
                    <td></td>
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['cgst_amount'] ?? 0)); ?></td>
                    <td></td>
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['sgst_amount'] ?? 0)); ?></td>
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['total_tax'] ?? 0)); ?></td>
                </tr>
            </tbody>
        </table>
    <?php else: ?>
            ...
            <tbody>
                <?php $__currentLoopData = $taxSummaryRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="code"><?php echo e($row['hsn_sac_code']); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['taxable_value'])); ?></td>
                        <td><?php echo e($fmtPercent($row['igst_rate'])); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['igst_amount'])); ?></td>
                        <td>₹<?php echo e($fmtMoney($row['total_tax'])); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr class="tax-total-row">
                    ...
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['taxable_value'] ?? 0)); ?></td>
                    <td></td>
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['igst_amount'] ?? 0)); ?></td>
                    <td>₹<?php echo e($fmtMoney($taxSummaryTotals['total_tax'] ?? 0)); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <td style="width: 64%; padding-left: 6px;">
            ...
            <table class="bank-table">
                <tr>
                    ...
                    <td class="bank-value"><?php echo e($bank['account_no'] ?? '129663700000319'); ?></td>
                </tr>
                <tr>
                    <td class="bank-label">Account name</td>
                    <td class="bank-colon">:</td>
                    <td class="bank-value"><?php echo e($bank['account_name'] ?? 'Bandara LLP'); ?></td>
                </tr>
                <tr>
                    <td class="bank-label">IFSC</td>
                    <td class="bank-colon">:</td>
                    <td class="bank-value"><?php echo e($bank['ifsc'] ?? 'YESB0001296'); ?></td>
                </tr>
                <tr>
                    <td class="bank-label">Bank</td>
                    <td class="bank-colon">:</td>
                    <td class="bank-value"><?php echo e($bank['bank_name'] ?? 'Yes Bank Ltd.'); ?></td>
                </tr>
            </table>
        </td>
        <td class="qr-wrap" style="width: 36%;">
            <?php if($qrPng): ?>
                <img src="data:image/png;base64,<?php echo e($qrPng); ?>" alt="Payment QR">
            <?php endif; ?>
        </td>
    </tr>
</table>
...
<div class="signoff">
    Sincerely,<br><br>
    <strong><?php echo e($seller['signature_name'] ?? 'For Bandara by Maytira'); ?></strong>
</div>

<div class="company-footer">
    FSSAI No: <?php echo e($seller['fssai_no'] ?? '21526079001348'); ?><br>
    GSTIN No: <?php echo e($seller['gstin_no'] ?? '27ABEFB3240N1ZE'); ?>

</div>

<div class="company-address">
    <?php echo e($seller['address'] ?? '303B, Nityanand Complex, 247A, Bund Garden Road, Pune 411001. MH. India'); ?>
...
<?php /**PATH /Users/ooglie/Website/ChatGPT/PRODUCTIONFrozen/BandaraFrozen/resources/views/invoices/pdf.blade.php ENDPATH**/ ?>
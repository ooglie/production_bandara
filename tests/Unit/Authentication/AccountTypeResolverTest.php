...
{
    public function test_it_recognises_all_existing_staff_role_variants(): void
    {
        ...
        self::assertTrue($resolver->isStaff((object) ['role' => 'Support']));
        self::assertTrue($resolver->isStaff((object) ['role' => 'Stores']));
        self::assertTrue($resolver->isStaff((object) ['role' => 'DeliveryAgent']));

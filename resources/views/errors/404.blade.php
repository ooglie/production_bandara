...
<head>
    ...
    <title>Page not found | {{ config('app.name', 'Bandara') }}</title>
    <style>
        :root {
    ...
    <main class="bandara-error-shell" role="main">
        <section class="bandara-error-card" aria-labelledby="bandara-error-title">
            ...
            <div class="bandara-error-content">
                ...
                <form class="bandara-error-search" method="GET" action="{{ url('/shop') }}">
                    <input
                        type="search"
                        name="q"
                ...
                <div class="bandara-error-actions">
                    <a href="{{ url('/shop') }}" class="bandara-error-button bandara-error-button-primary">
                        Continue shopping
                    </a>
                    <a href="{{ url('/') }}" class="bandara-error-button bandara-error-button-secondary">
                        Go to homepage
                    </a>
                    <button type="button" class="bandara-error-button bandara-error-button-secondary" onclick="window.history.length > 1 ? window.history.back() : window.location.assign('{{ url('/') }}')">
                        Go back
                    </button>
                </div>

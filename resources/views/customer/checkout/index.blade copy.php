...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-xs space-y-4">
    ...
    @endif
                    ...
                    @php
                        $customerDeliverySchedule = (array) config('delivery.customer_schedule', []);
                        $customerDeliveryScheduleNote = trim((string) config('delivery.customer_schedule_note', ''));
                    @endphp

                    @if(!empty($customerDeliverySchedule))
                        <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 sm:p-5">
                            <div>
                                <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-50">
                                    Delivery schedule
                                ...
                                <p class="mt-1 text-[11px] text-gray-500 dark:text-gray-400">
                                    Your expected delivery window depends on when your order is successfully placed.
                                </p>
                            </div>

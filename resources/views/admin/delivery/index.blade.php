    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Configure Pune delivery zones, pincode mapping, delivery fees, and cold-chain handling / packing charges.
            </p>
        </div>
        <div class="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-xs text-gray-600 shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            Store pincode: <span class="font-semibold text-gray-900 dark:text-gray-50">{{ config('delivery.store_pincode', '411001') }}</span>
        </div>
    </div>

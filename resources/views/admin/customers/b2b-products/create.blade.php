...
<div class="max-w-4xl mx-auto px-4 py-6 text-xs space-y-4">
    ...
    <form method="POST" action="{{ route('admin.customers.b2b-products.store', $user) }}" class="space-y-3">
        @csrf

        @include('admin.customers.b2b-products._form', ['user' => $user, 'products' => $products])

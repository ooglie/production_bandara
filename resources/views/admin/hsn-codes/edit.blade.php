...
<div class="max-w-4xl mx-auto px-4 py-6 text-xs space-y-4">
    ...
    <form method="POST" action="{{ route('admin.hsn-codes.update', $hsnCode) }}" class="space-y-3">
        @csrf
        @method('PUT')

        @include('admin.hsn-codes._form', ['hsnCode' => $hsnCode])

        <div class="flex items-center justify-between">
            <a href="{{ route('admin.hsn-codes.index') }}" class="text-[11px] text-gray-500 hover:underline">Back</a>
            <button type="submit"

@php
    ...
    $b2bWeightFinalizationUrl = $has('admin.b2b.weight-finalization.index') ? route('admin.b2b.weight-finalization.index') : null;
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 text-sm text-gray-600 dark:text-gray-300">
        ...
        @canany(['view stores', 'manage stores'])
            <div class="mb-4">
                ...
                @if($b2bWeightFinalizationUrl)
                    <a href="{{ $b2bWeightFinalizationUrl }}"
                       class="block px-2 py-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">
                        B2B Weight Finalization
                    </a>
                @endif

...
use App\Http\Controllers\Customer\{
    ...
    ProfileController,
    B2BStorefrontController as CustomerB2BStorefrontController,
...
use App\Http\Controllers\Admin\{
    ...
    B2BWeightFinalizationController,
...
Route::get('/', [HomeController::class, 'index'])
    ->middleware('b2c.storefront')
    ->name('home');
Route::get('/shop', [ShopController::class, 'index'])->middleware('b2c.storefront')->name('shop.index');
...
// CART ROUTES
Route::get('/cart', [CartController::class, 'index'])->middleware('b2c.storefront')->name('cart.index');
Route::post('/cart', [CartController::class, 'store'])->middleware('b2c.storefront')->name('cart.store');
Route::post('/cart/add', [CartController::class, 'add'])->middleware('b2c.storefront')->name('cart.add');
Route::patch('/cart/{key}', [CartController::class, 'update'])->middleware('b2c.storefront')->name('cart.update');
Route::delete('/cart/{key}', [CartController::class, 'destroy'])->middleware('b2c.storefront')->name('cart.destroy');

// CART COUPON
Route::post('/cart/coupon', [CartController::class, 'applyCoupon'])->middleware('b2c.storefront')->name('cart.coupon.apply');
Route::delete('/cart/coupon', [CartController::class, 'removeCoupon'])->middleware('b2c.storefront')->name('cart.coupon.remove');
...
// B2B CUSTOMER STOREFRONT
Route::middleware(['auth', 'role:Customer', 'verified'])
    ->prefix('b2b')
    ->name('b2b.')
    ->group(function () {
        Route::get('/', [CustomerB2BStorefrontController::class, 'dashboard'])->name('dashboard');
        Route::get('/portfolio', [CustomerB2BStorefrontController::class, 'portfolio'])->name('portfolio');
        Route::get('/catalog', [CustomerB2BStorefrontController::class, 'catalog'])->name('catalog.index');
        Route::get('/catalog/{product:slug}', [CustomerB2BStorefrontController::class, 'show'])->name('catalog.show');
        Route::post('/catalog/{product:slug}/request', [CustomerB2BStorefrontController::class, 'storeRequest'])->name('catalog.request');
...
Route::middleware(['auth', 'role:Customer'])->group(function () {
    ...
    Route::middleware('verified')->group(function () {
        ...
        // Wishlist routes are B2C storefront features. B2B users should use /b2b.
        Route::middleware('b2c.storefront')->group(function () {
            Route::get('/wishlist', [WishlistController::class, 'index'])->name('wishlist.index');
            Route::post('/wishlist', [WishlistController::class, 'store'])->name('wishlist.store');
            Route::delete('/wishlist/{item}', [WishlistController::class, 'destroy'])->name('wishlist.destroy');
        });
        ...
        Route::post('/checkout', [CheckoutController::class, 'place'])->middleware('b2c.storefront')->name('checkout.place');
...
Route::middleware(['auth', 'role:Admin|Manager|Accountant|CAAccountant|Stores'])
    ...
    ->group(function () {
        ...
        Route::middleware('role:Admin|Manager|Stores')->group(function () {
            ...
            Route::get('/b2b-weight-finalization', [B2BWeightFinalizationController::class, 'index'])
                ->name('b2b.weight-finalization.index');

            Route::get('/b2b-weight-finalization/{order}', [B2BWeightFinalizationController::class, 'show'])
                ->name('b2b.weight-finalization.show');

            Route::post('/b2b-weight-finalization/{order}', [B2BWeightFinalizationController::class, 'finalize'])
                ->name('b2b.weight-finalization.finalize');
